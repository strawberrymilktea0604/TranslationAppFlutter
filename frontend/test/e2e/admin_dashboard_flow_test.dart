...
void main() {
  group('Admin Dashboard Flow E2E Tests', () {
    ...
    testWidgets('A1: Admin can login with valid credentials', (
      WidgetTester tester,
    ) async {
      // Arrange
    ...
    testWidgets('A2: Admin login fails with non-admin account', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
    ...
    testWidgets('A3: Admin can view dashboard with statistics', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
    ...
    testWidgets('A4: Admin can view user list', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
      await E2EAuthFlow.loginAsAdmin(tester);
      await E2EScreenNavigation.navigateToAdminDashboard(tester);
      ...
      for (final user in E2ETestSeedData.seedAdminUsers) {
        expect(find.text(user['email'] as String), findsOneWidget);
      }
    });

    testWidgets('A5: Admin can ban a user', (WidgetTester tester) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
      await E2EAuthFlow.loginAsAdmin(tester);
      await E2EScreenNavigation.navigateToAdminDashboard(tester);
    ...
    testWidgets('A7: Admin can view question banks', (
      ...
      for (final bank in E2ETestSeedData.seedQuestionBanks) {
        expect(find.text(bank['title'] as String), findsOneWidget);
      }
    });

    testWidgets('A8: Admin can create a new question bank', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
    ...
    testWidgets('A9: Admin can edit a question bank', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
    ...
    testWidgets('A10: Admin can add question to quiz', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
      ...
      E2ETestExpectations.expectSuccessMessage(tester, 'Đã tạo câu hỏi mới');
    });

    testWidgets('A11: Admin can edit quiz question', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
      ...
      // Assert
      E2ETestExpectations.expectSuccessMessage(tester, 'Đã cập nhật câu hỏi');
    });

    testWidgets('A12: Admin can delete quiz question', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
      ...
      final deleteButtonInRow = find
          .widgetWithText(OutlinedButton, 'Xóa')
          .first;
      ...
      // Assert
      E2ETestExpectations.expectSuccessMessage(tester, 'Đã xóa câu hỏi');
    });

    testWidgets('A13: Admin can toggle question bank active status', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
    ...
    testWidgets('A14: Admin logout from dashboard', (
      WidgetTester tester,
    ) async {
      // Arrange
      await tester.pumpWidget(const AdminApp());
